...
def addPics(num,res,no):
    for x in range(0,num):
        ...
        image_url=f"https://storage.sekai.best/sekai-jp-assets/thumbnail/chara_rip/res{res[x]}_no{no[x]}_after_training.png"
        ...
        image_url=f"https://storage.sekai.best/sekai-jp-assets/thumbnail/chara_rip/res{res[x]}_no{no[x]}_normal.png"
        img_data = requests.get(image_url).content

...
for x in range(0,num):
    ...
    image_url=f"https://storage.sekai.best/sekai-assets/character/member_cutout/res{res[x]}_no{no[x]}_rip/after_training.png"
    print(image_url)
    ...
    image_url=f"https://storage.sekai.best/sekai-assets/character/member_cutout/res{res[x]}_no{no[x]}_rip/normal.png"
    img_data = requests.get(image_url).content
